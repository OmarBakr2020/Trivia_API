...
class TriviaTestCase(unittest.TestCase):
    ...
    def test_404_error_getting_questions(self):
    ...
    def test_404_sent_getting_non_existing_category(self):
        res = self.client().get('/categories/546')
        data = json.loads(res.data)
    ...
    def test_delete_question(self):
        ...
        self.assertEqual(res.status_code, 200)
        self.assertEqual(data['success'], True)
        self.assertEqual(data['deleted'], str(15))
        self.assertEqual(question, None)

    def test_422_sent_deleting_non_existing_question(self):
        res = self.client().delete('/questions/5896')
        data = json.loads(res.data)
